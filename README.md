...
## 🌟 新特性 / New Features
- **[2026.04.14]** 本地倍速插件：设置页新增「时间倍速（1x-1000x）」选项和常用倍率快捷按钮，可直接调节游戏识别到的时间推进倍率，并自动随存档保存与加载。
- **[2026.04.14]** 中文包来源替换：本地 `src/lang/zh.js` 与 `src/lang/zh/` 已替换为 `https://gooboo.g8hh.com.cn/1.5.3/` 对应构建中的中文语言包文案。
